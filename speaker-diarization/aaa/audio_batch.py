...
def audio_batch(audio_activity_path, output_dir, min_silene_duration_ms=250, min_speech_duration_ms=1000 * 5):
    ...
    util.save_file(json.dumps(batches), audio_batch_path)
    util_sub.save_segments_as_srt(batches, os.path.join(output_dir, 'audio_batch.srt'))
